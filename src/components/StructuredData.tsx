...
const SITE_NAME = 'Boise Dumpster Rental'
const SITE_URL = 'https://boise-dumpster-rental.com'
const SITE_PHONE = '+1-208-943-5231'
const SERVICE_NAME = 'Dumpster Rental Services'
    ...
    image: [
      {
        ...
        name: 'Dumpster Rental Services in the Treasure Valley',
        caption: 'Boise Dumpster Rental crew at work in Nampa, Idaho',
        contentLocation: {
          '@type': 'Place',
          name: 'Nampa, Idaho',
          geo: { '@type': 'GeoCoordinates', latitude: 43.5644, longitude: -116.5635 },
        },
      },
    ],
    aggregateRating: {
